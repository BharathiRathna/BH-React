                            ...
                            {!showVideo ? (
                                ...
                                <div className="w-full h-full relative">
                                    ...
                                    <iframe
                                        ...
                                        src="https://www.youtube.com/embed/VbZD5UlMgyQ?autohide=1&autoplay=1&controls=1&enablejsapi=1&hl=en&cc_load_policy=0&cc_lang_pref=en&fs=1&iv_load_policy=3&modestbranding=1&rel=0&showinfo=0&wmode=transparent"
                                        title="YouTube video"
                                        frameBorder="0"
                                    ...
                                    <button
                                        ...
                                        className="absolute top-2 right-2 text-[#f7eedf] p-2 rounded-full flex items-center justify-center w-[30px] h-[30px] border border-[#f7eedf]  border-2  bg-black bg-opacity-60"
                                    >
                                        <svg
                                            ...
                                            strokeWidth="3"
                                            stroke="currentColor"
                                            className="w-4 h-4 pointer-events-none overflow-visible"
                                        >
                                            <path
                                                strokeLinecap="round"
